...
function createTubeGLTF(points, radius, segments) {
  ...
  // Define a basic material with double-sided rendering
  let materials = [
    {
      pbrMetallicRoughness: {
        baseColorFactor: [1.0, 0.5, 0.5, 1.0] // Reddish color, fully opaque
      },
      doubleSided: true
    }
  ];
        ...
        primitives: [
          {
            ...
            indices: 1,
            material: 0 // Reference to the first material
          }
        ]
      }
    ],
    materials: materials, // Add materials array here
...
// createTubeGLTF(convertedPolesData, 0.5, 16, 'multiple_tubes.gltf');